...
df_qr_rel=pd.read_excel(r"qr\merchant_details\merchant_release_details.xlsx")
df_qr_mer=pd.read_excel(r"qr\merchant_details\merchant_details.xlsx")





common = set(df_qr_rel['MERCHANT_ID']) & set(df_qr_mer['_id'])
